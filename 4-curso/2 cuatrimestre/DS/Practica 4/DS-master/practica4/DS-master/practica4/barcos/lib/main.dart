        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                ElevatedButton(
                  key: Key("crearBarcoGrandeButton"),
                  onPressed: () {
                    _aniadirGrande();
                  },
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                        key: Key("enviarComentarioButton"),
                        onPressed: () {
            ...
            Container(
              ...
              child: DropdownButton<int>(
                ...
                items:List.generate(widget.usuario.barcos.length, (index) {
                  if(widget.usuario.barcos[index].getTipo() == "Pequenio") {
                      contadorPequenio++ ; 
                      contador = contadorPequenio ; 
                  }else {
                      contadorGrande++ ; 
                      contador = contadorGrande ; 
                  }
                    return DropdownMenuItem<int>(
                      value: index,
                      child: Center(
                        child: Text(
                           " Barco " + widget.usuario.barcos[index].getTipo() + " " + contador.toString(), // Cambia esto por la propiedad adecuada del barco
