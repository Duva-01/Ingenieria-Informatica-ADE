...
unsigned char * LeerArchivoJPEG( const char *nombre_arch, unsigned &ancho, unsigned &alto )
{
   ...
   // const std::string nombre_arch_path     = PathCarpetaMateriales() + "/imgs/" + std::string(nombre_arch) ;
   // const std::string nombre_arch_path_pro = ProcesarNombreArchivo( std::string( nombre_arch_path ) );
   ...
   FILE *          infile     = fopen( nombre_arch_path.c_str(), "rb" );
