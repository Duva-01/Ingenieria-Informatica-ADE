...
/*  
	...
	Ahora deberá emplear un tipo enumerado que permita guardar el tipo de 
	carácter de letra_original. Considere que ahora podría ser: una letra 
	mayúscula, una letra minúscula, un dígito u otro carácter.
