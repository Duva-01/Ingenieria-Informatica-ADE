...
Escena1::Escena1()
{
   ...
   objetos.push_back( new Cubo(1.0, 1.0, 1.0) );
...
Escena2::Escena2()
{
   ...
   objetos.push_back(new Cilindro(15, 15, {0,0,1}));
   objetos.push_back(new Cono(20, 15));
   objetos.push_back(new Esfera(30, 15));
   objetos.push_back(new Aro(15, 15, 8, 2, 1, 1, 1));

   objetos.push_back( new SemiEsfera(30,30, {0,1,0}));
...
Escena3::Escena3()
{
   ...
   objetos.push_back( new Sombrilla());
   objetos.push_back( new MultiplesAros());
   objetos.push_back(new Excavadora());
