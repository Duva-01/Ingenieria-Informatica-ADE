...
public class Civitas {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        CasillaCalle casilla_1 = new CasillaCalle("Casa Rico", 3000, 140, 20);
        Casilla casilla_2 = new Casilla( "Etsiit");
        CasillaSorpresa casilla_3 = new CasillaSorpresa("Recogidas", null);
        ...
        for(int i=1; i<table_rico.getTodasCasillas().size(); i++){
            ...
            //if( table_rico.getCasilla(i) instaceof CasillaCalle )
