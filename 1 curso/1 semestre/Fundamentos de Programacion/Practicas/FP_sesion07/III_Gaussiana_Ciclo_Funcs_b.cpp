...
double funcionGaussiana (double valor_abcisa, double esperanza, double desviacion_t) {
...
int main() {			// Programa Principal
	...
	funcion_total = funcionGaussiana (valor_abcisa, esperanza, desviacion_t);
